...
public class SocketBindingPresenter extends Presenter<SocketBindingPresenter.MyView, SocketBindingPresenter.MyProxy> {
    ...
    private final EntityAdapter<SocketGroup> socketGroupAdapter;
    private final EntityAdapter<RemoteSocketBinding> remoteSocketAdapter;
    private final EntityAdapter<LocalSocketBinding> localSocketAdapter;
